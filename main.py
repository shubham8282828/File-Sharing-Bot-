...
async def setup_bot():
    ...
    bot_app.add_handler(CommandHandler("referral", referral_handler))      # ✅ New
    bot_app.add_handler(CommandHandler("refstats", referral_stats_handler)) # ✅ New
